...
def render(lore_lines):
        ...
        if line == "":
            ...
            for char in line:
                ...
                if char == '️':
                    ...
                    code_character = True
                # Check if this character is after a "and" symbol
                elif code_character is True:
                    code_character = False
                    # Check if it is changing color
                    if char in text_colors:
                        color = text_colors[char][1]
                        shadow_color = shadow_colors[char][1]
                    # Check if its a reset color code
                    elif char == "r":
                        color = (255, 255, 255)
                        italics = False
                        bolded = False
                    # Check if it is a bold color code
                    elif char == "l":
                        bolded = True
                    # Check if it is a italic color code
                    elif char == "o":
                        italics = True
                else:
                    ...
                    special_character = False
    # Line Processing is now complete
    ...
    # Height and Width Calculation Done
    ...
    # Draw on image using processed_lines

    # Draw Shadow of Characters
    x = 8
    line_number = 0
    for line in processed_lines:
